...
function data2Form(inFormElem, formParamsList) {
    ...
    // делает значения атрибутов id у формы уникальными на странице,
    // добавляя пространство имён
    // в виде префикса с id создаваемой формы и "_"
    ...
    function makeFormPart(itemDataH) {
        ...
        // label > span > text
        attrs.for = makeUID(itemDataH.name);
        ...
        case "radio":
            labelTag.setAttribute("class", "radio-lead");
            parWrap.appendChild(labelTag);
